...
export const Combobox = (props: ComboboxProps) => {
    ...
    <div {...props.api().rootProps}>
      ...
      <div class="flex focus-within:ring-2 rounded-md" {...props.api().controlProps}>
        ...
        <button class="border border-neutral-8 shrink-0 w-9  border-is-0 rounded-ie-md flex items-center justify-center" {...props.api().triggerProps}>
    ...
    <div class="z-10 w-full" {...props.api().positionerProps}>
      <Show when={props.options().length > 0}>
        <ul class="bg-neutral-1 border border-neutral-8 shadow-md max-h-[120px] overflow-y-auto rounded-md" {...props.api().contentProps}>

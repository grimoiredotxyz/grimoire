export const ABI_TRANSCRIPTIONS = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'string', name: 'original_media_metadata_uri', type: 'string' },
      { internalType: 'string', name: 'reference_source_media', type: 'string' },
...
export const CONTRACT_TRANSCRIPTIONS = {
  ...
  80001: {
    chainId: 80001,
    address: '0x5ab284A7bc45FBE6ec0f18cb779EbE6F75c3F7D3',
    abi: ABI_TRANSCRIPTIONS,
  },
}
